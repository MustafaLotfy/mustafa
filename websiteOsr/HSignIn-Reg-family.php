	...
	<section class='section' id='login-register-page'>
		<div class='w3-container'>
			<div class='row'>
				...
				<form class='register-form' method='post' action=".signupController::add_new_family().">
					<div class='col-sm-12'>
                        ...
                        <div class='form-group'>
					  	...
					  	<div class='form-group'>
					    	...
					    	<input name='starting_date' type='date' class='form-control' required>
					  	</div>
                                <!--	Select Countries -->
                        <div class='form-group'>
					  	...
					  	<div class='form-group'>
						    <button name='add-family-submit' class='btn btn-primary'>Sign up</button>
					  	</div>
					</div>
				</form>		
