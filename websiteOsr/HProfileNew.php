...
<div class='w3-threequarter w3-padding-16'>
		...
		<div class='w3-container'>
			<div>
                ...
                <form method='post' action='".editController::edit_user()."'>
                                                <fieldset>
                                                    ...
                                                    <center><legend style='margin-right: auto; margin-left: auto; display: block;'>Your image</legend></center>
                                                ...
                                                <input class ='w3-text-red w3-input'type='text' name='first_name' value='".$data[1]['first_name']."' placeholder='first Name'>
                                                
                                                <p style='margin-top:35px;'>last Name</p>
                                                <input class ='w3-text-red w3-input'type='text' name='last_name' value='".$data[1]['last_name']."' placeholder='last Name'>
                                                <br/>
                                                 <br/>
                                                <p>Email</p>
                                                <input class ='w3-text-red w3-input' type='text' value='".$data[1]['email']."' name='email' placeholder='Enter Email'>
                                                <br/>
                                                 <br/>
                                                
                                                <p>Address</p>
                                                <input class ='w3-text-red w3-input' type='text' value='".$data[1]['address']."' name='address' placeholder='Enter Adress'>
                                                <br/>
                                                 <br/>
                                                
                                                <p>phone number</p>
                                                <input class ='w3-text-red w3-input' type='text' value='".$data[1]['phone_number']."' name='phone_number' placeholder='Enter number'>
                                                <br/>
                                                 <br/>
                                                ...
                                                <p>New Password</p>
                                                <input class ='w3-text-red w3-input' type='Password' name='password_conformation' placeholder='••••••••'>
										...
										<br/>
										<br/>
										<input class='w3-btn w3-blue' type='submit' name='edit-user-submit' style='float:right;'value='Update'>
                                        <br/>
										<br/> 
                                        <br/> 
                                        <br/>
