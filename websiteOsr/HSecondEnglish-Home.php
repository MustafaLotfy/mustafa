		...
		<div class="w3-container">
			<div class="row w3-container">
				<div class="section-title">
					<h3 class="title">قائمة الأسر المنتجة</h3>
					<hr>
				...
				<?php  
                    ...
                    <li class="product text-center col-xs-12 col-sm-6 col-md-4 col-lg-3">
						...
						<div class="price">
                            ...
                            <button id="<?php echo $i ?>" onclick="follow('<?php echo "$id";?>','<?php echo "$i";?>')" class="btn btn-cart"><i class="fa fa-heart"></i>unfollow </button> <br/>
                                <?php
                            } else {
                                ?>
                              <button id="<?php echo $i ?>" onclick="follow('<?php echo "$id";?>','<?php echo "$i";?>')" class="btn btn-cart"><i class="fa fa-heart"></i> follow </button> <br/>
                                <?php
                            }
                               }?>
...
function follow(id,counter)
{
 var xhttp = new XMLHttpRequest();
  ...
  if(check.includes("un"))
  {
  xhttp.open("GET", "unfollow.php?id="+id, true);
  xhttp.send(); 
    document.getElementById(counter+"").innerHTML="follow";
    }
    else
    {
         xhttp.open("GET", "follow.php?id="+id, true);
  xhttp.send(); 
    document.getElementById(counter+"").innerHTML="unfollow";
    }
}
