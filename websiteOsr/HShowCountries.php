...
<div class='w3-threequarter w3-padding-16'>
	<div class="col-sm-12">
					<table class="table table-responsive products-table">
					    ...
					    <tbody>
					    	<tr class="empty-products text-center" style="display: none;">
					            <td colspan="5">
						           <h3>لا يوجد منتجات في السلة</h3>
						           <a class="btn btn-cart active" href="index.html">عودة الى التسوق</a>
					            </td>
					        </tr>
					        ...
					        <tr>
					            ...
					            <td class="product-title">
						            ...
						            <a href="#!"><h3>قميص احمر اللون</h3></a>
					            </td>
					            <td class="product-price">
						           <a id='delete'href="delete.php?id=<?php echo $id;?>"   class="btn btn-cart"><i class="fa fa-trash-o"></i> delete </a>
					            </td>
					            <td class="product-quantity">
					            	<a id='delete'href="delete.php?id=<?php echo $id;?>"   class="btn btn-cart"><i class="fa fa-user-circle-o"></i> add admin </a>
					            </td>
					            <td class="product-subtotal">
						            <a id='delete'href="delete.php?id=<?php echo $id;?>"   class="btn btn-cart"><i class="fa fa-picture-o"></i> add photo </a>
					            </td>
					        </tr>
